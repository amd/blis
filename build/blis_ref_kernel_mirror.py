...
def remove_lines_in_file(filename):
    ...
    file_content = file_content.replace(
        ...
        'add_subdirectory(${BLIS_ROOT_BINARY_DIR}/ref_kernels/generic '
        '${BLIS_ROOT_BINARY_DIR}/ref_kernels/generic)\n'
        'add_subdirectory(${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen '
        '${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen)\n'
        'add_subdirectory(${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen2 '
        '${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen2)\n'
        'add_subdirectory(${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen3 '
        '${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen3)\n'
        'add_subdirectory(${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen4 '
        '${BLIS_ROOT_BINARY_DIR}/ref_kernels/zen4)\nelse()', '\n')
